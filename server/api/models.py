...
class Price(models.Model):
    ...
    BNT = models.FloatField(null=True)
    CVC = models.FloatField(null=True)
    DGD = models.FloatField(null=True)
    DNT = models.FloatField(null=True)
    EOS = models.FloatField(null=True)
    ETH = models.FloatField(null=True)
    FUN = models.FloatField(null=True)
    GNO = models.FloatField(null=True)
    GNT = models.FloatField(null=True)
    ICN = models.FloatField(null=True)
    KNC = models.FloatField(null=True)
    LUN = models.FloatField(null=True)
    MCO = models.FloatField(null=True)
    NMR = models.FloatField(null=True)
